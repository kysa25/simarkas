                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link" href="list-kor.php">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
									<?php
										$query = mysqli_query($koneksi,"SELECT * FROM akses where bidang like '$bidang'");
									...
									?>
										<tr>
											...
											<!--<td><a style="text-decoration: none" href="hapus.php?id=<?php echo $data['id']; ?>">Batal</a></td>-->
