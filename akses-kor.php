                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="korwas.php">
							...
							<a class="nav-link" href="akses-kor.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-file-circle-check"></i></div>
                                Akses
                            </a>
							<a class="nav-link" href="status-kor.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-file-circle-check"></i></div>
                                Status
                            </a>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
									<?php
										$query = mysqli_query($koneksi,"SELECT * FROM dokumen where bidang like '$bidang'");
									...
									?>
										<tr>
											...
											<td><?php echo $data['no_lhp'];?></td>
											<td><?php echo $data['tgl_lhp'];?></td>
											<td><a style="text-decoration: none" href="akses-p.php?id=<?php echo $data['id']; ?>"><input type="submit" value="Ajukan"></a></td>
										</tr>
										<?php
										}
										?>
