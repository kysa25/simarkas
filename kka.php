                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
									<?php
										$query = mysqli_query($koneksi,"SELECT dokumen.st, dokumen.tgl_st, dokumen.penugasan, dokumen.no_lhp, dokumen.tgl_lhp, kka.no_kka, kka.tgl_kka from dokumen, kka WHERE dokumen.st=kka.st");
